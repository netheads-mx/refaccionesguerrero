...
export default function CajaCotizacionesPage() {
  ...
  return (
    <div style={{ minHeight: '100dvh', background: '#060A12', color: '#F0F0F0' }}>
      {/* Header */}
      <header
        style={{
          display: 'flex',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          {user && (
            <span style={{ fontSize: '11px', color: '#555', marginLeft: '4px' }}>
              {user.rol === 'administrador' ? 'Todas las sucursales' : 'Mi sucursal'}
            </span>
          )}
        </div>
      </header>
      ...
      <div style={{ padding: '24px 20px', maxWidth: '1200px', margin: '0 auto' }}>
        {loading ? (
          <div style={{ color: '#888', fontSize: '13px', padding: '60px 0', textAlign: 'center' }}>
                        ...
                        <td colSpan={8} style={{ padding: 0 }}>
                          ...
                          >
                            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                              <thead>
                                <tr>
                                  <th style={{ ...thStyle, fontSize: '10px', padding: '4px 8px' }}>Producto</th>
                                  <th style={{ ...thStyle, fontSize: '10px', padding: '4px 8px' }}>No. Serie</th>
                                  <th style={{ ...thStyle, fontSize: '10px', padding: '4px 8px', textAlign: 'center' }}>Cant.</th>
                                  <th style={{ ...thStyle, fontSize: '10px', padding: '4px 8px', textAlign: 'right' }}>P. Unit.</th>
                                  <th style={{ ...thStyle, fontSize: '10px', padding: '4px 8px', textAlign: 'right' }}>Subtotal</th>
                                </tr>
                              </thead>
                              <tbody>
                                {c.detalles.map((d) => (
                                  <tr key={d.id}>
                                    <td style={{ ...tdStyle, fontSize: '12px', padding: '6px 8px' }}>{d.producto.nombre}</td>
                                    <td style={{ ...tdStyle, fontSize: '11px', padding: '6px 8px', color: '#666' }}>{d.producto.numeroSerie}</td>
                                    <td style={{ ...tdStyle, fontSize: '12px', padding: '6px 8px', textAlign: 'center' }}>{d.cantidad}</td>
                                    <td style={{ ...tdStyle, fontSize: '12px', padding: '6px 8px', textAlign: 'right' }}>{fmtMXN(d.precioUnit)}</td>
                                    <td style={{ ...tdStyle, fontSize: '12px', padding: '6px 8px', textAlign: 'right', fontWeight: 600 }}>{fmtMXN(d.subtotal)}</td>
                                  </tr>
                                ))}
                              </tbody>
                            </table>
            ...
            <div style={{ padding: '20px' }}>
              ...
              >
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', paddingTop: '8px', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
                  ...
                  <span style={{ color: '#22C55E', fontWeight: 700, fontSize: '15px' }}>{fmtMXN(convertModal.total)}</span>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', gap: '8px', marginBottom: '16px' }}>
                <button
                  ...
                  style={{
                    ...
                    border: `1px solid ${metodoPago === 'efectivo' ? '#22C55E' : 'rgba(255,255,255,0.08)'}`,
                    background: metodoPago === 'efectivo' ? 'rgba(34,197,94,0.1)' : 'rgba(255,255,255,0.02)',
                ...
                <button
                  ...
                  style={{
                    flex: 1, padding: '10px', borderRadius: '6px',
                    border: `1px solid ${metodoPago === 'transferencia' ? '#22C55E' : 'rgba(255,255,255,0.08)'}`,
                    background: metodoPago === 'transferencia' ? 'rgba(34,197,94,0.1)' : 'rgba(255,255,255,0.02)',
                ...
                <div style={{ marginBottom: '16px' }}>
                  ...
                  <input
                    ...
                    style={{
                      ...
                      borderRadius: '6px', color: '#F0F0F0', fontSize: '13px', outline: 'none',
                    }}
                  />
                </div>
              )}
              ...
              <div style={{ display: 'flex', gap: '10px' }}>
                <button
                  ...
                  disabled={converting}
                  className="btn-ghost"
                  style={{ flex: 1, padding: '11px', fontSize: '13px', justifyContent: 'center' }}
                >
                  Cancelar
                </button>
                <button
                  ...
                  style={{
                    ...
                    background: '#22C55E', color: '#fff', cursor: converting ? 'wait' : 'pointer',
                    fontSize: '13px', fontWeight: 700, opacity: converting ? 0.6 : 1,
                    display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px',
                  }}
                >
